...
// install/doctor loops, and atomic file replacement. Codex and Devin keep
// only their wire-protocol adapters and spec declarations (payload fields,
// output envelopes, event and tool names, probe commands) in
// internal/codexhook and internal/devinhook.
package hookcore
